            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-xl mb-8">
                  ...
                  Free consultation and guaranteed results. Available 24/7 for emergency services.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <CallButton phoneNumber={PHONE_NUMBER} variant="secondary" />
                  <a 
                    href="#services" 
                    className="btn-secondary inline-flex items-center justify-center text-lg bg-white/10 hover:bg-white/20"
                  >
                    Our Services
                  </a>
                </div>
